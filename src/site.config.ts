...
export const theme: ThemeUserConfig = {
  ...
  footer: {
    ...
    social: { github: 'https://github.com/wink-snow' }
  },
...
export const integ: IntegrationUserConfig = {
  ...
  links: {
    ...
    applyTip: [
      ...
      { name: 'Link', val: 'https://blog.snowink.store/' },
      { name: 'Avatar', val: 'https://blog.snowink.store/favicon/favicon.ico' }
    ]
  },
  ...
  waline: {
    enable: true,
    // Server service link
    server: 'https://waline-blog-d921gbg97-wink-snows-projects.vercel.app/',
